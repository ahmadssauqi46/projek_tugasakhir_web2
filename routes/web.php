...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/students', [AdminController::class, 'placeholder'])->name('students.index')->defaults('title','Data Siswa');
    Route::get('/teachers', [AdminController::class, 'placeholder'])->name('teachers.index')->defaults('title','Data Guru');
    Route::get('/classes', [AdminController::class, 'placeholder'])->name('classes.index')->defaults('title','Data Kelas');
    Route::get('/sub-bab', [AdminController::class, 'index'])->name('subbab.index');
