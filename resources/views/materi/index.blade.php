...
<section class="section">
    <div class="container">
        ...
        <p class="muted">7 sub bab belajar dasar komputer. Selesaikan latihan 5 soal agar materi berikutnya terbuka.</p>
                    ...
                    <div class="card-soft p-4 h-100">
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="small muted">{{ $module->summary }}</p>
                                
                                <span class="badge {{ $done ? 'status-done' : ($locked ? 'status-lock' : 'status-open') }} mb-3">
                                    {{ $done ? 'Selesai' : ($locked ? 'Terkunci' : 'Terbuka') }}
                                </span>
                                <br>
                                
                                @if($locked)
                                    <button class="btn btn-soft btn-sm" disabled>Pelajari Materi</button>
                                @else
